...
struct MovePowerModifierCalculation {
    struct Start {
        fileprivate let value = MovePowerModifier.denominator

        func applying(_ modifier: MovePowerModifier) -> Modified {
            Modified(value: MovePowerModifierCalculation.apply(modifier, to: value))
        }
    ...
    private static func apply(_ modifier: MovePowerModifier, to currentValue: Int) -> Int {
